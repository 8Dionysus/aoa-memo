...
GENERATED = ROOT / 'generated/agon_sophian_memo_evidence_registry.min.json'
SCRIPT = ROOT / 'scripts/build_agon_sophian_memo_evidence_registry.py'
VALIDATOR = ROOT / 'scripts/validate_agon_sophian_memo_evidence_registry.py'
EXPECTED_COUNT = 6
