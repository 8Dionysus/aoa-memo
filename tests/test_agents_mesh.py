...
class AgentsMeshTestCase(unittest.TestCase):
    ...
    def test_agents_mesh_index_names_current_cards(self) -> None:
        ...
        self.assertEqual(76, payload["counts"]["canonical"])
        ...
        self.assertEqual(
            {
                ...
                "mechanics/readiness-boundary/parts/AGENTS.md",
                ...
                "mechanics/recurrence-support/parts/AGENTS.md",
                ...
                "mechanics/lineage-harvest/parts/AGENTS.md",
                ...
                "mechanics/retention/parts/AGENTS.md",
                ...
                "mechanics/writeback/parts/AGENTS.md",
