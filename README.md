...
- recall contracts and memory-object examples: `examples/recall_contract.*.json`, `examples/core_memory_contract.example.json`, `mechanics/writeback/examples/checkpoint_to_memory_contract.example.json`, and `examples/memory_object_surface_manifest.json`
...
- recurrence support, witness trace, and reviewed closeout recall landings:
  ...
  `mechanics/recurrence-support/schemas/witness-trace.schema.json`, `mechanics/recurrence-support/schemas/inquiry_checkpoint.schema.json`,
  and `mechanics/recurrence-support/examples/inquiry_checkpoint.return.example.json`
...
- [mechanics/adoption](mechanics/adoption/README.md),
  ...
  operational-gate/recurrence-support/lineage-harvest/writeback/retention
  docs-root families
