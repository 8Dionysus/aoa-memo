...
- failure-lesson doctrine and contract surfaces: [docs/FAILURE_LESSON_MEMORY](docs/FAILURE_LESSON_MEMORY.md), [docs/FAILURE_LESSON_RECALL](docs/FAILURE_LESSON_RECALL.md), `schemas/failure_lesson_memory_v1.json`, `examples/failure_lesson_memory.example.json`, and `examples/failure_lesson_memory.lineage.example.json`
