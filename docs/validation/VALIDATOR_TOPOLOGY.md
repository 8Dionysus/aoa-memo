...
| Trace/Eval Validators | Repo-local regression harnesses. | regression | `docs/testing/TEST_TOPOLOGY.md` | Full trajectory, tool-call, state, outcome, grader, and dataset evals route to `aoa-evals`. |
