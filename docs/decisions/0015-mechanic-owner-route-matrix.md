...
- Legacy path: docs/decisions/2026-05-18-mechanic-owner-route-matrix.md
...
python -m pytest -q tests/test_memo_mechanic_owner_routes.py tests/test_memo_mechanic_readiness.py
