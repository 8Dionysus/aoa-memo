...
lineage-harvest, writeback, and retention are now memo mechanics under
...
| Readiness boundary | [readiness-boundary mechanic](../mechanics/readiness-boundary/README.md) plus the readiness boundary contract schema, example, generated refs, and tests |
...
| Readiness-boundary mechanic | [mechanics/readiness-boundary/AGENTS](../mechanics/readiness-boundary/AGENTS.md), then [mechanics/readiness-boundary/README](../mechanics/readiness-boundary/README.md) |
...
| [mechanics/readiness-boundary](../mechanics/readiness-boundary/README.md) | Readiness boundary memo mechanic |
