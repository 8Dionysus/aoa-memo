...
| Validator topology | `docs/validation/` | active validator boundary-layer law, command-authority balance, and validator inventory; executable lane sequences still live in `config/validation_lanes.json` |
