...
- `aoa-memo` does not certify proof, current health, runtime cleanup, role
  authority, KAG promotion, or owner adoption.
- Shape guard may block or route a bad memory form; it does not execute
  deletion or replace stronger owner truth.
