...
| Source meaning and adoption | source owner repository |

`aoa-memo` may block or route a bad memory shape. It must not claim that a
stronger owner accepted the replacement, executed cleanup, or certified truth.
