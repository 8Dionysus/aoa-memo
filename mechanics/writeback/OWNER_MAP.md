...
| Concern | Owner |
|---|---|
| Writeback memory posture, source maps, and generated memo companions | `aoa-memo` |
| Runtime stores, workers, live receipts, retention execution | `abyss-stack` |
