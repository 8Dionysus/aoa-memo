...
| Receipt publication regression | `mechanics/writeback/parts/receipt-publication-regression/tests/fixtures/memo_writeback_receipts.example.jsonl`, `mechanics/writeback/parts/receipt-publication-regression/tests/`, `mechanics/writeback/parts/receipt-publication-regression/scripts/publish_live_receipts.py` | keeps tracked writeback receipts part-local and recall-surface backed |
