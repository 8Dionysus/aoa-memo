...
| Receipt publication regression | `mechanics/writeback/tests/fixtures/memo_writeback_receipts.example.jsonl`, `mechanics/writeback/tests/test_publish_live_receipts.py` | keeps tracked writeback receipts package-local and recall-surface backed |
