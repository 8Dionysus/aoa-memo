...
python -m pytest -q tests/test_downstream_feed_contracts.py tests/test_quest_chronicle_writeback.py tests/test_self_agency_continuity_writeback.py tests/test_a2a_child_return_writeback.py
```
