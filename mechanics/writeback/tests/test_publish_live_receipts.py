...
GROWTH_REFINERY_LANES_PATH = REPO_ROOT / "mechanics" / "writeback" / "generated" / "growth_refinery_writeback_lanes.min.json"
...
REVIEWED_CANDIDATE_CASES = {
    ...
    "distillation_bridge_candidate": {
        ...
        "source_path": "mechanics/consumer-handoff/examples/bridge.kag-lift.example.json",
        "target_kind": "bridge",
        "review_state": "proposed",
        "writeback_anchor_ref": "repo:aoa-memo/mechanics/consumer-handoff/docs/KAG_TOS_BRIDGE_CONTRACT.md#end-to-end-flow",
        "candidate_seed_ref": "repo:aoa-memo/mechanics/consumer-handoff/examples/claim.tos-bridge-ready.example.json",
    },
}
GROWTH_LANE_CASES = {
...
class MemoPublishLiveReceiptsTests(unittest.TestCase):
    ...
    def test_tracked_receipt_fixture_resolves_to_recall_surface_family(self) -> None:
        ...
        for receipt in receipts:
            ...
            self.assertIn(
                f"repo:aoa-memo/mechanics/writeback/generated/growth_refinery_writeback_lanes.min.json#{lane_ref}",
                evidence_refs,
            )
