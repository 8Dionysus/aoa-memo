...
def test_quest_chronicle_example_validates_against_schema() -> None:
    ...
    example = load_json("mechanics/writeback/examples/quest_chronicle.example.json")
...
def test_quest_chronicle_surfaces_stay_discoverable_and_non_sovereign() -> None:
    ...
    assert "mechanics/writeback/schemas/quest_chronicle.schema.json" in readme
    assert "mechanics/writeback/examples/quest_chronicle.example.json" in readme
