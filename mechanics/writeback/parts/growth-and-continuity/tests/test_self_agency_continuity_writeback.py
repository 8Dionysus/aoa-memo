...
def test_self_agency_continuity_example_validates_against_provenance_thread_schema() -> None:
    ...
    example = load_json("mechanics/writeback/parts/growth-and-continuity/examples/provenance_thread.self-agency-continuity.example.json")
...
def test_self_agency_continuity_memory_object_ids_hydrate_through_recall_surfaces() -> None:
    ...
    expected_paths = {
        "memo.decision.2026-04-12.self-agency-reanchor-window": "mechanics/writeback/parts/growth-and-continuity/examples/decision.self-agency-reanchor-window.example.json",
        "memo.state.2026-04-12.self-agency-continuity-relay": "mechanics/writeback/parts/growth-and-continuity/examples/state_capsule.self-agency-continuity-relay.example.json",
    }
