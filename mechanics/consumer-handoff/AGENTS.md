...
python -m pytest -q mechanics/consumer-handoff/parts/downstream-feed-regression/tests/test_consumer_handoff_mechanic.py tests/mechanics/test_memo_mechanics.py tests/agents/test_agents_mesh.py mechanics/consumer-handoff/parts/playbook-scope-handoff/tests/test_playbook_memory_scopes.py mechanics/consumer-handoff/parts/downstream-feed-regression/tests/test_downstream_feed_contracts.py tests/memory/test_memo_handoff_boundaries.py
```
