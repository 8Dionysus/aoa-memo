...
- [MCP owner evidence review](mcp-owner-evidence-review/README.md) - authenticates one stack capture and binds the returned memo brief to the current reviewed-corpus read model without inferring acceptance
