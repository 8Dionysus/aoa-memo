...
PART_ROOT = (
    REPO_ROOT / "mechanics" / "adoption" / "parts" / "adoption-boundary"
)

CONTRACTS = {
    "adoption_duplicate_memory_cluster": "adoption_duplicate_memory_cluster_v1.json",
    "adoption_forgetting_decision": "adoption_forgetting_decision_v1.json",
    "adoption_memory_writeback": "adoption_memory_writeback_v1.json",
}
...
def test_adoption_boundary_contracts_are_part_local_and_validate() -> None:
...
def test_adoption_boundary_contracts_reject_missing_required_fields() -> None:
    for stem, schema_file in CONTRACTS.items():
