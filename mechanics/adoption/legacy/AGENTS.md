...
This card applies to `mechanics/adoption/legacy/`.

## Role

Legacy preserves adoption placement provenance from the former flat docs-root
surface.

It is not the active route for adoption doctrine and must not become a place to
hide new work.
...
- Start from active adoption surfaces before using legacy.
...
Report legacy index changes, active adoption surfaces consulted, and whether
