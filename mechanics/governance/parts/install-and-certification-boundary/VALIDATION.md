...
python -m pytest -q tests/test_experience_wave2_seed_contracts.py mechanics/operational-gate/parts/post-release-boundaries/tests/test_experience_wave5_seed_contracts.py
```
