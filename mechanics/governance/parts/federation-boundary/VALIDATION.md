...
python -m pytest -q tests/test_experience_wave3_seed_contracts.py mechanics/lineage-harvest/parts/pattern-lineage-memory-gate/tests/test_lineage_harvest_mechanic.py
```
