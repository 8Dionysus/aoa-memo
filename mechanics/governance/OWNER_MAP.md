# Governance Owner Map

| Concern | Owner |
|---|---|
| Governance, federation, precedent, stay-order, installation, and certification memory posture | `aoa-memo` |
| Center governance, federation program law, and release-law posture | `Agents-of-Abyss` |
...
`aoa-memo` may preserve bounded governance memory and recall posture. It must
not claim stronger owner behavior has landed.
