# Obligation index Contract

## Owner Boundary

`aoa-memo` owns this part only as a bounded memory-layer operation inside `mechanics/questbook/`.
...
compact list of open memo-facing obligations; not a second roadmap
