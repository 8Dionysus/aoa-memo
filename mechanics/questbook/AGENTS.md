...
`docs/QUEST_SOURCE_CONTRACT.md`, `QUESTBOOK.md`, and `quests/README.md`.
...
- Generated quest catalog and dispatch files are projections from quest source
  files; rebuild them rather than editing by hand.
...
- Generated projections changed: rebuild with the package builder and run the
  generated checks.
