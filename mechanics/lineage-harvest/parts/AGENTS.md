...
This card applies to `mechanics/lineage-harvest/parts/` and every nested active part.

## Role

`mechanics/lineage-harvest/parts/` holds functioning part contracts for the Lineage Harvest memo mechanic.
...
When this task touches the path, consult root `AGENTS.md`, `mechanics/AGENTS.md`, `mechanics/lineage-harvest/AGENTS.md`,
`mechanics/lineage-harvest/DIRECTION.md`, `mechanics/lineage-harvest/PARTS.md`,
`mechanics/lineage-harvest/OWNER_MAP.md`, `mechanics/lineage-harvest/PROVENANCE.md`, and the
nearest part `README.md`, `CONTRACT.md`, and `VALIDATION.md`.

## Boundaries

- Keep each part tied to one row in `mechanics/lineage-harvest/PARTS.md`.
- Keep detailed source meaning in the source docs named by the part.
- Keep former placement evidence in `mechanics/lineage-harvest/PROVENANCE.md` and `legacy/`.
- Route stronger proof, runtime, role, route, KAG, playbook, stats, ToS, or source-owner claims through `OWNER_MAP.md`.

## Validation

Use the package validation route in `mechanics/lineage-harvest/AGENTS.md`.
