...
GENERATED = ROOT / 'mechanics/agon/generated/agon_sophian_memo_evidence_registry.min.json'
SCRIPT = ROOT / 'mechanics/agon/scripts/build_agon_sophian_memo_evidence_registry.py'
VALIDATOR = ROOT / 'mechanics/agon/scripts/validate_agon_sophian_memo_evidence_registry.py'
EXPECTED_COUNT = 6
