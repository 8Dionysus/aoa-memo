...
SRC = ROOT / 'mechanics/agon/config/agon_sophian_memo_evidence.seed.json'
OUT = ROOT / 'mechanics/agon/generated/agon_sophian_memo_evidence_registry.min.json'
ENTRY_SCHEMA = ROOT / 'mechanics/agon/schemas/agon-sophian-memo-evidence.schema.json'
REGISTRY_SCHEMA = ROOT / 'mechanics/agon/schemas/agon-sophian-memo-evidence-registry.schema.json'
BUILDER = ROOT / 'mechanics/agon/scripts/build_agon_sophian_memo_evidence_registry.py'
