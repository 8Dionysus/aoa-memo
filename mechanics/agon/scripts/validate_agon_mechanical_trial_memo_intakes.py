...
SRC = ROOT / 'mechanics/agon/config/agon_mechanical_trial_memo_intakes.seed.json'
OUT = ROOT / 'mechanics/agon/generated/agon_mechanical_trial_memo_intake_registry.min.json'
