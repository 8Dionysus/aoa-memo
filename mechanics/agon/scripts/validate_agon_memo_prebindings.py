...
CONFIG = ROOT / 'mechanics/agon/config/agon_memo_prebindings.seed.json'
GENERATED = ROOT / 'mechanics/agon/generated/agon_memo_prebinding_registry.min.json'
RECORD_KEY = 'prebindings'
BUILDER = ROOT / 'mechanics' / 'agon' / 'scripts' / 'build_agon_memo_prebinding_registry.py'
