...
REGISTRY = ROOT / "mechanics/agon/generated/agon_retention_rank_memo_bridge_registry.min.json"
SCHEMA = ROOT / "mechanics/agon/schemas/agon-retention-rank-memo-bridge-registry.schema.json"
BUILDER = ROOT / "mechanics/agon/scripts/build_agon_retention_rank_memo_bridge_registry.py"
