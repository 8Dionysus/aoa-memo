...
CONFIG = ROOT / "mechanics/agon/config/agon_retention_rank_memo_bridge.seed.json"
OUTPUT = ROOT / "mechanics/agon/generated/agon_retention_rank_memo_bridge_registry.min.json"
...
def build_registry():
    ...
    return {
        ...
        "source_config": "mechanics/agon/config/agon_retention_rank_memo_bridge.seed.json",
