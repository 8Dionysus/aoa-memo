...
SRC = ROOT / 'mechanics/agon/config/agon_kag_memo_evidence_packages.seed.json'
OUT = ROOT / 'mechanics/agon/generated/agon_kag_memo_evidence_package_registry.min.json'
ENTRY_SCHEMA = ROOT / 'mechanics/agon/schemas/agon-kag-memo-evidence-package.schema.json'
REGISTRY_SCHEMA = ROOT / 'mechanics/agon/schemas/agon-kag-memo-evidence-package-registry.schema.json'
BUILDER = ROOT / 'mechanics/agon/scripts/build_agon_kag_memo_evidence_package_registry.py'
