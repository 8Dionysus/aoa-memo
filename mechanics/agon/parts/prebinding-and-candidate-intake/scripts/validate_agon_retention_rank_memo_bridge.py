...
REGISTRY = ROOT / "mechanics/agon/parts/prebinding-and-candidate-intake/generated/agon_retention_rank_memo_bridge_registry.min.json"
SCHEMA = ROOT / "mechanics/agon/parts/prebinding-and-candidate-intake/schemas/agon-retention-rank-memo-bridge-registry.schema.json"
BUILDER = ROOT / "mechanics/agon/parts/prebinding-and-candidate-intake/scripts/build_agon_retention_rank_memo_bridge_registry.py"
...
def expected_registry() -> dict:
    spec = importlib.util.spec_from_file_location("agon_retention_rank_memo_builder", BUILDER)
