...
This card applies to `mechanics/agon/parts/` and every nested active part.

## Role

`mechanics/agon/parts/` holds functioning part contracts for the Agon memo mechanic.
...
When this task touches the path, consult root `AGENTS.md`, `mechanics/AGENTS.md`, `mechanics/agon/AGENTS.md`,
`mechanics/agon/DIRECTION.md`, `mechanics/agon/PARTS.md`,
`mechanics/agon/OWNER_MAP.md`, `mechanics/agon/PROVENANCE.md`, and the
nearest part `README.md`, `CONTRACT.md`, and `VALIDATION.md`.

## Boundaries

- Keep each part tied to one row in `mechanics/agon/PARTS.md`.
- Keep detailed source meaning in the source docs named by the part.
- Keep former placement evidence in `mechanics/agon/PROVENANCE.md` and `legacy/`.
- Route stronger proof, runtime, role, route, KAG, playbook, stats, ToS, or source-owner claims through `OWNER_MAP.md`.

## Validation

Use the package validation route in `mechanics/agon/AGENTS.md`.
