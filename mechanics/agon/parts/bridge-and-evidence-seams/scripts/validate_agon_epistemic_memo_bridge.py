...
from build_agon_epistemic_memo_bridge_registry import (  # noqa: E402
    BuildError,
    ITEM_KEY,
    OUT,
    REGISTRY_ID,
...
EXPECTED_COUNT = 7
KEY_FIELD = "bridge_id"
REQUIRED_FIELDS = ['bridge_id', 'candidate_outputs', 'forbidden_effects', 'intake_for', 'live_protocol', 'owner_repo', 'runtime_effect', 'status']
...
ITEM_SCHEMA = ROOT / "mechanics/agon/parts/bridge-and-evidence-seams/schemas/agon-epistemic-memo-bridge.schema.json"
REGISTRY_SCHEMA = ROOT / "mechanics/agon/parts/bridge-and-evidence-seams/schemas/agon-epistemic-memo-bridge-registry.schema.json"
...
def validate_item(item: Any, item_validator: jsonschema.Draft202012Validator) -> str | None:
    ...
    if item.get("owner_repo") != "aoa-memo":
        return f"{key} owner_repo must be aoa-memo"
