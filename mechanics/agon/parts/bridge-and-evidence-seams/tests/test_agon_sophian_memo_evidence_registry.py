...
GENERATED = ROOT / 'mechanics/agon/parts/bridge-and-evidence-seams/generated/agon_sophian_memo_evidence_registry.min.json'
SCRIPT = ROOT / 'mechanics/agon/parts/bridge-and-evidence-seams/scripts/build_agon_sophian_memo_evidence_registry.py'
VALIDATOR = ROOT / 'mechanics/agon/parts/bridge-and-evidence-seams/scripts/validate_agon_sophian_memo_evidence_registry.py'
EXPECTED_COUNT = 6
