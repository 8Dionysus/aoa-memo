...
PART_ROOT = REPO_ROOT / "mechanics" / "retention" / "parts" / "office-markers"
...
def test_office_marker_contracts_are_part_local_and_validate() -> None:
...
def test_office_marker_schemas_reject_missing_required_fields() -> None:
    for stem, schema_file in CONTRACTS.items():
