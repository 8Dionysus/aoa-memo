...
def validator(schema_name: str) -> Draft202012Validator:
    schema = load_json(f"mechanics/titan/parts/recall-and-remembrance-posture/schemas/{schema_name}")
...
def test_titan_memory_candidate_requires_time_boundary_and_risk_pair() -> None:
    payload = load_json(
        "mechanics/titan/parts/recall-and-remembrance-posture/examples/titan_memory_candidate.example.json"
    )
