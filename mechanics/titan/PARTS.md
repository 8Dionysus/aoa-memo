...
| Audit, personality, and swarm policy | [TITAN_AUDIT_MEMORY_POLICY](./docs/TITAN_AUDIT_MEMORY_POLICY.md), [TITAN_PERSONALITY_MEMORY_POLICY](./docs/TITAN_PERSONALITY_MEMORY_POLICY.md), [TITAN_SWARM_MEMORY_POLICY](./docs/TITAN_SWARM_MEMORY_POLICY.md) | keeps audit, personality, and swarm memory posture reviewable |
