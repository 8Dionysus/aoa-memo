...
For repeatable antifragility, adoption, writeback, or retention movement, read
`mechanics/README.md`.
...
| `mechanic-change` | Antifragility, Agon, Titan, adoption, writeback, retention, owner split, legacy bridge, artifact placement, or mechanic-facing validation changes | `mechanics/README.md` -> target mechanic `AGENTS.md` -> `mechanics/ARTIFACT_TOPOLOGY.md` when artifacts move -> mechanics validators |
