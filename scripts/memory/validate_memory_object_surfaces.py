...
def validate_recall_contract(
    ...
    *,
    ...
    if data.get("inspect_surface") != "generated/memory-objects/memory_object_catalog.min.json":
        errors.append("inspect_surface must stay generated/memory-objects/memory_object_catalog.min.json")
    ...
    if data.get("expand_surface") != "generated/memory-objects/memory_object_sections.full.json":
        errors.append("expand_surface must stay generated/memory-objects/memory_object_sections.full.json")
...
def main() -> int:
    ...
    validate_recall_contract(
        RECALL_EXAMPLES / "recall_contract.object.working.json",
    ...
    validate_recall_contract(
        RECALL_EXAMPLES / "recall_contract.object.working.phase-alpha.json",
        expected_mode="working",
        expected_allowed_scopes=["thread", "session", "project"],
    ...
    validate_recall_contract(
        RECALL_EXAMPLES / "recall_contract.object.working.return.json",
        expected_mode="working",
        expected_allowed_scopes=["thread", "session", "project"],
        expected_preferred_kinds=["state_capsule", "decision", "episode", "audit_event", "anchor"],
        expected_temperature_order=["hot", "warm", "cool", "frozen", "cold"],
    ...
    validate_recall_contract(
        RECALL_EXAMPLES / "recall_contract.object.semantic.json",
    ...
    validate_recall_contract(
        RECALL_EXAMPLES / "recall_contract.object.lineage.json",
