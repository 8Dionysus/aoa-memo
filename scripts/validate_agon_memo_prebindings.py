...
CONFIG = ROOT / 'config/agon_memo_prebindings.seed.json'
GENERATED = ROOT / 'generated/agon_memo_prebinding_registry.min.json'
RECORD_KEY = 'prebindings'
BUILDER = ROOT / 'scripts' / 'build_agon_memo_prebinding_registry.py'
