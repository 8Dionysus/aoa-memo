...
CONFIG_PATH = REPO_ROOT / "config" / "root_technical_districts.json"
GENERATED_PATH = REPO_ROOT / "generated" / "root_technical_districts.min.json"

SCHEMA_VERSION = "aoa_memo_root_technical_districts_index_v1"
CONFIG_REF = "config/root_technical_districts.json"
SOURCE_OF_TRUTH = "mechanics/ARTIFACT_TOPOLOGY.md"
GENERATED_BY = "scripts/build_root_technical_districts_index.py"
...
DISTRICT_GUIDE = {
    "config": {
        ...
        "check": "python scripts/validate_mechanic_artifact_topology.py",
    },
    "examples": {
        ...
        "check": "python scripts/validate_memo.py",
    },
    "generated": {
        ...
        "check": "python scripts/validate_root_technical_districts_index.py",
    },
    "manifests": {
