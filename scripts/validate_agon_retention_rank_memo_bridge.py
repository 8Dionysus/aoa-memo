...
REGISTRY = ROOT / "generated/agon_retention_rank_memo_bridge_registry.min.json"
SCHEMA = ROOT / "schemas/agon-retention-rank-memo-bridge-registry.schema.json"
BUILDER = ROOT / "scripts/build_agon_retention_rank_memo_bridge_registry.py"
