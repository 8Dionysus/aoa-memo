...
SRC = ROOT / 'config/agon_sophian_memo_evidence.seed.json'
OUT = ROOT / 'generated/agon_sophian_memo_evidence_registry.min.json'
ENTRY_SCHEMA = ROOT / 'schemas/agon-sophian-memo-evidence.schema.json'
REGISTRY_SCHEMA = ROOT / 'schemas/agon-sophian-memo-evidence-registry.schema.json'
BUILDER = ROOT / 'scripts/build_agon_sophian_memo_evidence_registry.py'
