...
SRC = ROOT / 'config/agon_kag_memo_evidence_packages.seed.json'
OUT = ROOT / 'generated/agon_kag_memo_evidence_package_registry.min.json'
ENTRY_SCHEMA = ROOT / 'schemas/agon-kag-memo-evidence-package.schema.json'
REGISTRY_SCHEMA = ROOT / 'schemas/agon-kag-memo-evidence-package-registry.schema.json'
BUILDER = ROOT / 'scripts/build_agon_kag_memo_evidence_package_registry.py'
