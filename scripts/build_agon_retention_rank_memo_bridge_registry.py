...
CONFIG = ROOT / "config/agon_retention_rank_memo_bridge.seed.json"
OUTPUT = ROOT / "generated/agon_retention_rank_memo_bridge_registry.min.json"
...
def build_registry():
    ...
    return {
        ...
        "source_config": "config/agon_retention_rank_memo_bridge.seed.json",
