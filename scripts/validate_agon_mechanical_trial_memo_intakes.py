...
SRC = ROOT / 'config/agon_mechanical_trial_memo_intakes.seed.json'
OUT = ROOT / 'generated/agon_mechanical_trial_memo_intake_registry.min.json'
ITEM_KEY = 'memo_intakes'
REQUIRED_FIELDS = ['id', 'trial_id', 'candidate_intakes', 'allowed_records']
...
def expected_registry(data, items):
    return {
        'registry_id': data.get('registry_id', 'agon.mechanical_trial_memo_intake.registry.v0'),
