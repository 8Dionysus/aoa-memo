...
SRC = ROOT / 'config/agon_slc_memo_bridge.seed.json'
OUT = ROOT / 'generated/agon_slc_memo_bridge_registry.min.json'
ENTRY_SCHEMA = ROOT / 'schemas' / 'agon-slc-memo-bridge.schema.json'
REGISTRY_SCHEMA = ROOT / 'schemas' / 'agon-slc-memo-bridge-registry.schema.json'
BUILDER = ROOT / 'scripts' / 'build_agon_slc_memo_bridge_registry.py'
